# taken from https://github.com/NVIDIA/partialconv/blob/master/models/loss.py
...
class VGG16PartialLoss(PerceptualLoss):
    ...
    def __init__(
        self,
        l1_alpha=5.0,
        perceptual_alpha=0.05,
        style_alpha=120,
        smooth_alpha=0,
        feat_num=3,
        vgg_path="/home/zack466/.torch/vgg16-397923af.pth",
    ):
        """
        Init
        ...
        if self.vgg_weight != 0 or self.style_weight != 0:
            ...
            if self.vgg_weight > 0:
                ...
                for m in range(len(generated) - self.feat_num, len(generated)):
                    ...
                    vgg_loss += self.vgg_weight * self.loss_fn(generated[m], gt_data)
            ...
            if self.style_weight > 0:
                ...
                for m in range(len(generated) - self.feat_num, len(generated)):
                    ...
                    style_loss += self.style_weight * self.loss_fn(gen_style, gt_style)
